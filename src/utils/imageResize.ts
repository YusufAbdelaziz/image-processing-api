...
export default async function resizeImageMiddleware(req: express.Request, res: express.Response): Promise<void> {
  // res.write('waiting');
...
/**
 * @description Resizes an image given its resize requirements.
